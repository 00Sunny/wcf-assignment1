...
namespace ConsoleApp1.ServiceReference1 {
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<ConsoleApp1.ServiceReference1.IService1>, ConsoleApp1.ServiceReference1.IService1 {
        ...
        internal string PrintHTMLTag(string inputTag, string inputData)
        {
            throw new NotImplementedException();
        }
        ...
        internal string CalculateSumOfDigits(string input)
        {
            throw new NotImplementedException();
        }

        internal string SortNumbers(string choiceNumber, string input)
        {
            throw new NotImplementedException();
        }

        internal string CheckPrimeNumber(string input)
        {
            throw new NotImplementedException();
        }
    }
